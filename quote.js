...
"To be yourself in a world that is constantly trying to make you something else is the greatest accomplishment.” —Ralph Waldo Emerson"]
  function generate(){
    let numberIndex= Math.floor(Math.random() * quote.length);
    let edit = document.querySelector(".quote");
    edit.innerHTML=quote[numberIndex];
  }
  
  
  let buton = document.querySelector(".btn");
  buton.addEventListener('click',generate)
